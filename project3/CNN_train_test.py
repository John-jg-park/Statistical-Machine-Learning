...
"""
print('Loading data......')
sub_train_images, sub_train_labels, sub_test_images, sub_test_labels = init_subset('0471') # input your ASUID last 4 digits here to generate the subset samples of MNIST for training and testing
...
test_size = sub_test_images.shape[0]      # Obtain the size of testing samples  400
train_size = sub_train_images.shape[0]    # Obtain the size of training samples 2000
...
for e in range(epoch):
    ...
    for batch_index in range(0, sub_train_images.shape[0], batch_size):
        #print(batch_index, batch_size, sub_train_images.shape[0])
        # batch input
    ...
    print(e, train_acc_arr, train_loss_arr, test_acc_arr, test_loss_arr)
...
k=range(0,10)
plt.plot(k, train_acc_arr, marker='o')
...
k=range(0,10)
plt.plot(k, train_loss_arr, marker='o')
plt.xlabel('The number of Epoch')
...
k=range(0,10)
plt.plot(k, test_acc_arr, marker='o')
plt.xlabel('The number of Epoch')
...
k=range(0,10)
plt.plot(k, test_loss_arr, marker='o')
plt.xlabel('The number of Epoch')
